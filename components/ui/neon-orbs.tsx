...
export function NeonOrbs({
  ...
  return (
    <div className={`relative w-full h-full overflow-hidden ${backgroundColor}`}>
      ...
      {showText && (
        <div className="relative z-10 text-center text-foreground transition-colors duration-500">
          <h1
          ...
          <p
            className={`text-lg md:text-xl font-light tracking-widest text-muted-foreground transition-all duration-1000 ease-out ${
              mounted
                ? "opacity-100 translate-y-0 blur-0"
      ...
      <style jsx global>{`
        ...
        .beam-light {
          ...
          transition: all 0.5s;
          background: linear-gradient(90deg, transparent 0%, rgba(66, 66, 205, 0.3) 30%, rgba(66, 66, 205, 0.6) 70%, rgba(66, 66, 205, 0.8) 100%);
          box-shadow: 0 0 20px 4px rgba(66, 66, 205, 0.4), 0 0 40px 8px rgba(66, 66, 205, 0.2);
        }

        .orb-light {
          background: radial-gradient(circle at 50% 50%, rgba(255, 255, 255, 0.8) 0%, rgba(255, 255, 255, 0.6) 90%, transparent 100%);
          box-shadow:
            0 0 60px 2px rgba(66, 66, 205, 0.2),
            0 0 100px 5px rgba(66, 66, 205, 0.1),
            inset 0 0 60px 2px rgba(66, 66, 205, 0.05);
          border: 1px solid rgba(66, 66, 205, 0.2);
        }
